...
summary_long: >
  ...
  pairs using **zero-knowledge proofs**. The Dojo contracts feature 5 models and 2 systems
  for onchain game state. With a separate contracts repo and frontend, the game is **deployed
