...
Simple 3D first person shooter, connected to a vesu liquidation bot, allows the player to shoot in a random generated maze against an increasingly faster enemy, when the player dies the liquidation bot gets a number of liquidation earning assigned to the user's wallet, based on the number of killed enemies.

### GitHub
> Provide the GitHub where your project is hosted. Please ensure your github repo is registered with [OnlyDust](https://app.onlydust.com/p/create) to receive awards.
https://github.com/jilt/take-your-shot

### Play
> Provide instructions on how to play your game. It could be a URL, a README, or a link to a binary to install.
Playable on desktop and laptop pc, instructions are on the main page (use keyboard arrows to move/rotate and spacebar to shoot), here is the screenshot:
https://raw.githubusercontent.com/jilt/take-your-shot/refs/heads/main/Screenshot%202025-11-02%20112348.png
...
Laura Camellini, https://github.com/jilt, .jilt, @jeeltcraft
