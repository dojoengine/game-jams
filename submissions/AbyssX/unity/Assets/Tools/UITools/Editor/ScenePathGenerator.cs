...
namespace Abyss.Utils
{
    public static class ScenePathGenerator
{
    ...
    [MenuItem("工具/场景工具/自动生成场景索引路径")]
    public static unsafe void GenerateUIPath()
    {
        var targetFilePath = Path.Combine(Application.dataPath, "Core/ConstData/ScenePath.cs");
        var prefabs = AssetDatabase.FindAssets("t:SceneAsset");
