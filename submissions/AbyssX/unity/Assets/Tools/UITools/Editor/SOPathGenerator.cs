...
{
    public static class SOPathGenerator
{
    ...
    [MenuItem("工具/SO工具/自动生成SO索引路径")]
    public static unsafe void GenerateSOPath()
    {
        var targetFilePath = Path.Combine(Application.dataPath, "Core/ConstData/SOPath.cs");
        var prefabs = AssetDatabase.FindAssets("t:ScriptableObject", new []{"Assets/So"});
