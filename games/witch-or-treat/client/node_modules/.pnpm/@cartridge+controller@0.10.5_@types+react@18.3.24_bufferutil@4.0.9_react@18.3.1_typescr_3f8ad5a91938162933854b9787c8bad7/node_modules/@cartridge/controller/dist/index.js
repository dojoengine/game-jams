...
import { R as Q, t as Rt, K as Tt, B as Ut, N as v, p as zt, v as Dt, A as Ot } from "./provider-CznCrt4b.js";
import { F as qn, S as Gn, h as Xn, n as Jn, a as Zn, b as es } from "./provider-CznCrt4b.js";
class Le extends Nt {
  keychain;
  modal;
  options;
   ...
   */
  async execute(e) {
    return e = Rt(e), new Promise(async (r, n) => {
...
const Lt = (t, e) => {
  ...
  const c = (d) => {
    ...
    new Promise((m) => m(e[f].call(e, d.origin).apply(e, u))).then(k(z.Fulfilled), k(z.Rejected));
  };
...
let Kt = 0;
const Vt = () => ++Kt, nt = ".", st = (t) => t ? t.split(nt) : [], qt = (t) => t.join(nt), Gt = (t, e) => {
  const r = st(e || "");
  ...
  return (d) => {
    ...
    i && i(), i = Ht(h, t, s), a(i), l && l.forEach((u) => {
      delete c[u];
    }), l = d.data.methodNames;
    const f = Zt(c, h, l, o, s);
    return a(f), c;
  };
}, tr = (t, e, r, n) => (s) => {
  if (!s.source)
  ...
  return {
    promise: new Promise((k, m) => {
      ...
      window.addEventListener(T.Message, _), a("Parent: Awaiting handshake"), nr(e, i), l((p) => {
        window.removeEventListener(T.Message, _), p && m(p);
      });
    }),
    destroy() {
      c();
...
class ar {
  ...
  constructor({
    ...
    i.src = r.toString(), i.id = e, i.style.border = "none", i.sandbox.add("allow-forms"), i.sandbox.add("allow-popups"), i.sandbox.add("allow-popups-to-escape-sandbox"), i.sandbox.add("allow-scripts"), i.sandbox.add("allow-same-origin"), i.allow = "publickey-credentials-create *; publickey-credentials-get *; clipboard-write", document.hasStorageAccess && i.sandbox.add("allow-storage-access-by-user-activation");
    ...
    }), this.iframe = i, this.container = l, ir({
      iframe: this.iframe,
      methods: {
        close: (h) => () => this.close(),
    ...
    const c = new MutationObserver(() => {
      ...
      document.body && e === "controller-keychain" && !h && (document.body.appendChild(l), c.disconnect());
    });
    ...
    document.body && e === "controller-keychain" && !d && document.body.appendChild(l), this.onClose = s;
  }
  open() {
...
const pr = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
function yr(t) {
...
function Ur(t, e = 24) {
  ...
  for (let n = 24 - e; n < 24; n++) {
    ...
    for (let a = 0; a < 10; a += 2) {
      const i = (a + 8) % 10, l = (a + 2) % 10, c = r[l], d = r[l + 1], h = Ke(c, d, 1) ^ r[i], f = Ve(c, d, 1) ^ r[i + 1];
      for (let u = 0; u < 50; u += 10)
        t[a + u] ^= h, t[a + u + 1] ^= f;
    }
    let s = t[2], o = t[3];
    for (let a = 0; a < 24; a++) {
      const i = lt[a], l = Ke(s, o, i), c = Ve(s, o, i), d = ct[a];
...
const zr = (t, e, r) => _r(() => new $e(e, t, r)), Dr = zr(1, 136, 256 / 8);
let ft = !1;
const ut = function(t) {
  return Dr(t);
};
...
const mt = (t, e) => e === 0 ? t : mt(e, t % e), oe = /* @__NO_SIDE_EFFECTS__ */ (t, e) => t + (e - mt(t, e)), ue = /* @__PURE__ */ (() => {
  let t = [];
  for (let e = 0; e < 40; e++)
    t.push(2 ** e);
  return t;
...
const _t = (t) => {
  ...
  return {
    ...
    decodeStream(e) {
      let r;
      if (I(t) ? r = Number(t.decodeStream(e)) : typeof t == "number" ? r = t : typeof t == "string" && (r = O.resolve(e.stack, t)), typeof r == "bigint" && (r = Number(r)), typeof r != "number")
  ...
  set: (t, e, r, n = !0) => !n && (t[e] & r) !== 0 ? !1 : (t[e] |= r, !0),
  pos: (t, e) => ({
...
const An = 9, pe = H.decimal(An), K = x({
  encodeStream: (t, e) => {
    if (!e)
      return t.byte(0);
    for (; e; e >>= 7)
...
function Ue(t, e, r) {
  ...
  const n = Te(e, Object.keys(r).reduce((i, l, c) => ({ ...i, [l]: c }), {})), s = Object.keys(r).reduce((i, l) => ({ ...i, [l]: r[l].coder }), {}), o = kn(n, s);
  et[t] = (i, l) => {
    if (i.program !== t)
  ...
  for (const i in r)
    a[i] = (l) => ({
      ...
      keys: Object.keys(r[i].keys).map((c) => {
        ...
        return f || (f = l[c]), xn(f), { address: f, sign: d, write: h };
      })
    });
  return a;
}
...
Ue(Ct, $, {
  ...
  setAuthority: {
    ...
    keys: {
      account: { sign: !1, write: !0 },
      currentAuthority: { sign: !0, write: !1 }
    },
...
function Cn(t) {
  ...
  for (let c = 0; c < t.length; c++) {
    const d = t.charAt(c), h = d.charCodeAt(0);
    if (e[h] !== 255)
...
class Un extends ar {
  ...
  constructor({
    ...
    const l = new URL(e ?? Tt), c = new Tn();
    r && l.searchParams.set(
      "policies",
      encodeURIComponent(JSON.stringify(r))
    ), n && l.searchParams.set("v", encodeURIComponent(n)), s && l.searchParams.set("ps", encodeURIComponent(s)), o && l.searchParams.set("ns", encodeURIComponent(o)), a?.erc20 && l.searchParams.set(
      "erc20",
...
class Ln extends Ut {
  ...
  constructor(e = {}) {
    ...
    ], ...e.chains || []], s = e.defaultChainId || V.StarknetChainId.SN_MAIN;
  ...
  revoke(e, r) {
    return this.keychain ? this.keychain.revoke(e) : (console.error(new v().message), null);
  }
  rpcUrl() {
  ...
  async delegateAccount() {
    return this.keychain ? await this.keychain.delegateAccount() : (console.error(new v().message), null);
  }
  initializeChains(e) {
    for (const r of e)
      try {
        const n = new URL(r.rpcUrl), s = zt(n), o = s === V.StarknetChainId.SN_MAIN, a = s === V.StarknetChainId.SN_SEPOLIA, i = n.hostname === "api.cartridge.gg", l = n.hostname === "localhost" || n.hostname === "127.0.0.1";
        if ((o || a) && !(i || l))
          throw new Error(
