...
/** @internal */
export declare function signTypedData({ typedData, owner, }: {
...
/** @internal */
export declare function toReplaySafeTypedData({ address, chainId, hash, }: {
    address: Address;
    chainId: number;
    hash: Hash;
}): {
    ...
    readonly types: {
        readonly CoinbaseSmartWalletMessage: readonly [{
            readonly name: "hash";
            readonly type: "bytes32";
        }];
    };
    readonly primaryType: "CoinbaseSmartWalletMessage";
    readonly message: {
