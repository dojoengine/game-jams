...
exports.hash_to_decaf448 = exports.hashToDecaf448 = exports.DecafPoint = exports.encodeToCurve = exports.hashToCurve = exports.ed448_hasher = exports.edwardsToMontgomery = exports.x448 = exports.ed448ph = exports.ed448 = void 0;
...
const Fp = (0, modular_ts_1.Field)(ed448P, 456, true);
const ED448_DEF = {
    // Param: a
    a: BigInt(1),
 ...
 */
exports.x448 = (() => (0, montgomery_ts_1.montgomery)({
    a: BigInt(156326),
    // RFC 7748 has 56-byte keys, RFC 8032 has 57-byte keys
    montgomeryBits: 448,
    nByteLength: 56,
    ...
    powPminus2: (x) => {
        ...
        const Pminus3 = (0, modular_ts_1.pow2)(Pminus3div4, BigInt(2), P);
...
exports.ed448_hasher = (() => (0, hash_to_curve_ts_1.createHasher)(exports.ed448.ExtendedPoint, (scalars) => map_to_curve_elligator2_edwards448(scalars[0]), {
...
const bytes448ToNumberLE = (bytes) => exports.ed448.CURVE.Fp.create((0, utils_ts_1.bytesToNumberLE)(bytes) & MAX_448B);
...
const hashToDecaf448 = (msg, options) => {
    ...
    const uniform_bytes = (0, hash_to_curve_ts_1.expand_message_xof)(msg, DST, 112, 224, sha3_1.shake256);
