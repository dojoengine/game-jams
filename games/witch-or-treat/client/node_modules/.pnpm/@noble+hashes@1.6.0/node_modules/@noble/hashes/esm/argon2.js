...
import { toBytes, u8, u32, nextTick } from './utils.js';
...
export const argon2dAsync = (password, salt, opts) => argon2Async(0 /* Types.Argond2d */, password, salt, opts);
export const argon2iAsync = (password, salt, opts) => argon2Async(1 /* Types.Argon2i */, password, salt, opts);
export const argon2idAsync = (password, salt, opts) => argon2Async(2 /* Types.Argon2id */, password, salt, opts);
