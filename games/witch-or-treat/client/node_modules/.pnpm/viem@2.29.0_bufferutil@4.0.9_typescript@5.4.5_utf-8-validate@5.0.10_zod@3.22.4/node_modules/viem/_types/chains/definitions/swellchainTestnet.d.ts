export declare const swellchainTestnet: {
    blockExplorers: {
        readonly default: {
            readonly name: "Swellchain Testnet Explorer";
            readonly url: "https://swell-testnet-explorer.alt.technology";
            readonly apiUrl: "https://swell-testnet-explorer.alt.technology/api";
        };
    };
    contracts: {
        readonly multicall3: {
    ...
    rpcUrls: {
        readonly default: {
            readonly http: readonly ["https://swell-testnet.alt.technology"];
        };
    };
...
//# sourceMappingURL=swellchainTestnet.d.ts.map