...
import { type DepositParameters, type DepositReturnType } from '../actions/deposit.js';
...
export type WalletActionsL1<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     * })
     */
    deposit: <chainOverride extends Chain | undefined = undefined, chainL2 extends ChainEIP712 | undefined = ChainEIP712 | undefined, accountL2 extends Account | undefined = Account | undefined>(parameters: DepositParameters<chain, account, chainOverride, chainL2, accountL2>) => Promise<DepositReturnType>;
    /**
