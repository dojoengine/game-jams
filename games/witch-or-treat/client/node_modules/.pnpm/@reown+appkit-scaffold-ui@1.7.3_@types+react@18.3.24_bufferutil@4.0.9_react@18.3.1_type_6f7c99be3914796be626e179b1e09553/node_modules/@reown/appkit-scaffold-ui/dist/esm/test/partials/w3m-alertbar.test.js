...
describe('W3mAlertBar', () => {
    ...
    it('it should display the correct alert based on the variant', async () => {
        for (const { variant, message, preset } of ALERT_VARIANTS) {
            ...
            const alertBar = await fixture(html `<w3m-alertbar></w3m-alertbar>`);
            const { message: alertMessage, backgroundColor, icon, iconColor } = HelpersUtil.querySelect(alertBar, ALERBAR);
...
//# sourceMappingURL=w3m-alertbar.test.js.map