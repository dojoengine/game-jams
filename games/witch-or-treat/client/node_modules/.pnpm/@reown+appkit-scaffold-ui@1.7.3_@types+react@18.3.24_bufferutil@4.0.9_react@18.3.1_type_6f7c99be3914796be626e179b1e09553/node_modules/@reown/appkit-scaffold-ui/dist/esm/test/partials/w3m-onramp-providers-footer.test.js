...
describe('W3mOnRampProvidersFooter', () => {
    ...
    it('should render null when no terms or privacy URLs are provided', async () => {
        ...
        const element = await fixture(html `<w3m-onramp-providers-footer></w3m-onramp-providers-footer>`);
    ...
    it('should render footer content when URLs are provided', async () => {
        ...
        expect(textContent).toBe('We work with the best providers to give you the lowest fees and best support. More options coming soon!');
    });
...
//# sourceMappingURL=w3m-onramp-providers-footer.test.js.map