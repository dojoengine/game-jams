...
const mockNetworkControllerClient = {
...
const mockConnectionControllerClient = {
...
const mockChainControllerState = {
    ...
    chains: new Map([['eip155', mockChainAdapter]]),
    universalAdapter: {
        networkControllerClient: mockNetworkControllerClient,
        connectionControllerClient: mockConnectionControllerClient
    },
...
describe('W3mWalletSendPreviewView', () => {
    ...
    it('should render initial state with token details', async () => {
        const element = await fixture(html `<w3m-wallet-send-preview-view></w3m-wallet-send-preview-view>`);
    ...
    it('should handle send action', async () => {
        ...
        const element = await fixture(html `<w3m-wallet-send-preview-view></w3m-wallet-send-preview-view>`);
        await element.updateComplete;
        const button = element.shadowRoot?.querySelector('.sendButton');
        button?.click();
    ...
    it('should handle cancel action', async () => {
        ...
        const element = await fixture(html `<w3m-wallet-send-preview-view></w3m-wallet-send-preview-view>`);
        await element.updateComplete;
        const button = element.shadowRoot?.querySelector('.cancelButton');
        button?.click();
...
//# sourceMappingURL=w3m-wallet-send-preview-view.test.js.map