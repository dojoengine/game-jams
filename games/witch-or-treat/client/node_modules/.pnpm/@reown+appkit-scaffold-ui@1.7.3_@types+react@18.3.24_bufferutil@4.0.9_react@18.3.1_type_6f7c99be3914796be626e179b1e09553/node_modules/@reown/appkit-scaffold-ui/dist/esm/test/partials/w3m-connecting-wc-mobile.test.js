...
import { ConnectionController, ConstantsUtil, CoreHelperUtil, RouterController } from '@reown/appkit-controllers';
...
describe('W3mConnectingWcMobile', () => {
    ...
    it('should call openHref with _self if not in an iframe', async () => {
        ...
        const el = await fixture(html `<w3m-connecting-wc-mobile></w3m-connecting-wc-mobile>`);
        el['onConnect']();
    ...
    it('should reset labels and timeouts on Try Again', async () => {
        ...
        const onConnectSpy = vi.spyOn(el, 'onConnect');
...
//# sourceMappingURL=w3m-connecting-wc-mobile.test.js.map