...
describe('W3mSendSelectTokenView', () => {
    ...
    it('should render initial state with filtered tokens by chain', async () => {
        const element = await fixture(html `<w3m-wallet-send-select-token-view></w3m-wallet-send-select-token-view>`);
...
//# sourceMappingURL=w3m-wallet-send-select-token-view.test.js.map