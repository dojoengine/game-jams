...
export type WalletActionsEip5792<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     * })
     */
    getCapabilities: (...parameters: account extends JsonRpcAccount ? [] | [parameters: GetCapabilitiesParameters<account>] : [parameters: GetCapabilitiesParameters<undefined>]) => Promise<GetCapabilitiesReturnType>;
    /**
