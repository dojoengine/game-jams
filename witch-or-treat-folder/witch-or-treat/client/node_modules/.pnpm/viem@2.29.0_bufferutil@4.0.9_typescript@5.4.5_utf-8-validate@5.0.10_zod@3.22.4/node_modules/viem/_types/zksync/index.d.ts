export { type ToSmartAccountErrorType, type ToSmartAccountParameters, toSmartAccount, } from './accounts/toSmartAccount.js';
...
export { type DepositErrorType, type DepositReturnType, type DepositParameters, deposit, } from './actions/deposit.js';
...
/** @deprecated Use `zksync` instead */
zksyncInMemoryNode as zkSyncInMemoryNode, zksyncLocalCustomHyperchain, zksyncLocalHyperchain, zksyncLocalHyperchainL1, zksyncInMemoryNode, 
/** @deprecated Use `zksync` instead */
...
ZksyncRpcBlock as ZkSyncRpcBlock, ZksyncRpcBlock, ZksyncBatchDetails, ZksyncBlockDetails, ZksyncNumberParameter, } from './types/block.js';
export type { ChainEIP712 } from './types/chain.js';
export type { EIP712Domain, EIP712DomainFn, 
/** @deprecated Use `ZksyncEip712Meta` instead */
ZksyncEip712Meta as ZkSyncEip712Meta, ZksyncEip712Meta, } from './types/eip712.js';
export type { CommonDataRawBlockTransaction, RawBlockTransactions, PublicZksyncRpcSchema, 
/** @deprecated Use `PublicZksyncRpcSchema` instead */
PublicZksyncRpcSchema as PublicZkSyncRpcSchema, } from './types/eip1193.js';
export type { 
/** @deprecated Use `ZksyncFeeValues` instead */
ZksyncFeeValues as ZkSyncFeeValues, ZksyncFeeValues, } from './types/fee.js';
export type { 
...
ZksyncRpcLog as ZkSyncRpcLog, ZksyncRpcLog, } from './types/log.js';
