 ...
 */
export declare function getCapabilities<chain extends Chain | undefined, account extends JsonRpcAccount | undefined = undefined>(...parameters: account extends JsonRpcAccount ? [client: Client<Transport, chain, account>] | [
