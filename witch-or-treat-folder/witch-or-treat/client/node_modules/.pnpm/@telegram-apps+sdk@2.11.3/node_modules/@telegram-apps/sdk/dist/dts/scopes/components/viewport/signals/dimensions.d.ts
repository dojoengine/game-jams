 ...
 * @see stableHeight
 */
export declare const height: import('@telegram-apps/signals').Computed<number>;
/**
 ...
 * @see height
 */
export declare const stableHeight: import('@telegram-apps/signals').Computed<number>;
/**
 * Signal containing the currently visible area width.
 */
export declare const width: import('@telegram-apps/signals').Computed<number>;
