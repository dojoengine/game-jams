...
describe('W3mConnectFeaturedWidget', () => {
    ...
    it('should not render anything if there are no featured wallets', async () => {
        ...
        const element = await fixture(html `<w3m-connect-featured-widget .wallets=${featured}></w3m-connect-featured-widget>`);
    ...
    it('should render featured wallets', async () => {
        ...
        const walletSelector = HelpersUtil.getByTestId(element, `wallet-selector-featured-${MOCK_WALLET.id}`);
    ...
    it('should pass tabIdx to wallet list items when provided', async () => {
        ...
        const featured = WalletUtil.filterOutDuplicateWallets(ApiController.state.featured);
        const element = await fixture(html `<w3m-connect-featured-widget
        .wallets=${featured}
        .tabIdx=${1}
...
//# sourceMappingURL=w3m-connect-featured-widget.test.js.map