...
import { ChainController, ConnectionController, ConnectorController, EventsController, RouterController, SnackController } from '@reown/appkit-controllers';
...
describe('W3mEmailLoginWidget', () => {
    ...
    it('renders email input form', async () => {
        const element = await fixture(html `<w3m-email-login-widget></w3m-email-login-widget>`);
    ...
    describe('Form Submission', () => {
        it('redirects to network switch when on unsupported chain', async () => {
            vi.mocked(ChainController.state).activeChain = 'unsupported';
            const element = await fixture(html `<w3m-email-login-widget></w3m-email-login-widget>`);
...
//# sourceMappingURL=w3m-email-login-widget.test.js.map