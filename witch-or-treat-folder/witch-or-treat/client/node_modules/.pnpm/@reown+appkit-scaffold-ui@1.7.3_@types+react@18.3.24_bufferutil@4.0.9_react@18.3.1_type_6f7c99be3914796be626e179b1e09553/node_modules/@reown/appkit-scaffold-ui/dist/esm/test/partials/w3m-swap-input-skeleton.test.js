...
describe('W3mSwapInputSkeleton', () => {
    it('should render with default target', async () => {
        const element = await fixture(html `<w3m-swap-input-skeleton></w3m-swap-input-skeleton>`);
        expect(element.target).toBe('sourceToken');
    });
    it('should render with custom target', async () => {
        const element = await fixture(html `<w3m-swap-input-skeleton target="toToken"></w3m-swap-input-skeleton>`);
...
//# sourceMappingURL=w3m-swap-input-skeleton.test.js.map