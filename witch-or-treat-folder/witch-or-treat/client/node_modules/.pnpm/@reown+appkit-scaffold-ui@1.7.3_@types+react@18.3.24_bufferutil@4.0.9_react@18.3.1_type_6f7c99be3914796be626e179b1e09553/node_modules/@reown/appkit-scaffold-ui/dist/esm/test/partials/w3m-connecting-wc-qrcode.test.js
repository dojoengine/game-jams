...
describe('W3mConnectingWcQrcode', () => {
    ...
    it('it should display a QR code', async () => {
        ...
        const connectingQrCode = await fixture(html `<w3m-connecting-wc-qrcode></w3m-connecting-wc-qrcode>`);
        await new Promise(resolve => setTimeout(resolve, 300));
        const qrCode = HelpersUtil.querySelect(connectingQrCode, QR_CODE);
...
//# sourceMappingURL=w3m-connecting-wc-qrcode.test.js.map