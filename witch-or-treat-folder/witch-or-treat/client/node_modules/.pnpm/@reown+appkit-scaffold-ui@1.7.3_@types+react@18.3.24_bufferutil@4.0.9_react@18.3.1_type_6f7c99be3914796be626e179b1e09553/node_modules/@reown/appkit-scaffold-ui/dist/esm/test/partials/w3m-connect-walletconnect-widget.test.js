...
const OTHER_CONNECTOR = {
    id: 'otherConnector',
    name: 'Other Wallet',
    type: ConstantsUtil.CONNECTOR_TYPE_INJECTED,
    provider: undefined,
    chain: CommonConstantsUtil.CHAIN.EVM
};
describe('W3mConnectWalletConnectWidget', () => {
    ...
    it('should not render anything on mobile', async () => {
        ...
        const element = await fixture(html `<w3m-connect-walletconnect-widget></w3m-connect-walletconnect-widget>`);
...
//# sourceMappingURL=w3m-connect-walletconnect-widget.test.js.map