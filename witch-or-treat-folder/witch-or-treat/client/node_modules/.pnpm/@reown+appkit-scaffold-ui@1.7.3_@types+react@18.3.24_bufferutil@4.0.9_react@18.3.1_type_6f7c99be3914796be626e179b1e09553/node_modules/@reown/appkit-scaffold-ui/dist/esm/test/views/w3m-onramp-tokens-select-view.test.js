...
describe('W3mOnrampTokensView', () => {
    ...
    it('should render token list', async () => {
        const element = await fixture(html `<w3m-onramp-token-select-view></w3m-onramp-token-select-view>`);
    ...
    it('should handle subscription updates', async () => {
        ...
        vi.spyOn(OnRampController, 'state', 'get').mockReturnValue({
            ...OnRampController.state,
            purchaseCurrencies: updatedTokens
        });
        const updatedElement = await fixture(html `<w3m-onramp-token-select-view></w3m-onramp-token-select-view>`);
...
//# sourceMappingURL=w3m-onramp-tokens-select-view.test.js.map