...
import { ApiController, ConnectorController, OptionsController, RouterController, StorageUtil } from '@reown/appkit-controllers';
...
const MOCK_WALLET_CONNECT_CONNECTOR = {
    id: 'walletConnect',
    name: 'WalletConnect',
    type: 'WALLET_CONNECT',
    chain: CommonConstantsUtil.CHAIN.EVM
};
const MOCK_RECOMMENDED_WALLET = {
    id: 'mockWallet',
    name: 'Mock Wallet',
    mobile: {
        native: 'mock://wallet',
...
describe('W3mConnectRecommendedWidget', () => {
    ...
    it('should not render if WalletConnect connector is not available', async () => {
        ...
        const element = await fixture(html `<w3m-connect-recommended-widget
        .wallets=${recommended}
...
//# sourceMappingURL=w3m-connect-recommended-widget.test.js.map