...
import { ApiController, ChainController, ConnectorController, RouterController, StorageUtil } from '@reown/appkit-controllers';
...
describe('W3mConnectRecentWidget', () => {
    const mockRecentWallets = [
        { id: 'recent1', name: 'Recent Wallet 1', chains: ['eip155:1'] },
        { id: 'recent2', name: 'Recent Wallet 2', chains: ['eip155:1'] }
    ];
    ...
    it('should render filtered recent wallets when there are matching connectors', async () => {
        const element = await fixture(html `<w3m-connect-recent-widget></w3m-connect-recent-widget>`);
    ...
    it('should respect tabIdx property', async () => {
        const element = await fixture(html `<w3m-connect-recent-widget .tabIdx=${2}></w3m-connect-recent-widget>`);
        const walletElement = element.shadowRoot?.querySelector('wui-list-wallet');
    ...
    it('should filter wallets by EIP-155 chain namespace', async () => {
        const eip155Wallets = [
            ...
            { id: 'eth2', name: 'Polygon Wallet', chains: ['eip155:137'] }
        ];
    ...
    it('should filter wallets by Bitcoin chain namespace', async () => {
        const bitcoinWallets = [
            { id: 'btc1', name: 'Bitcoin Wallet', chains: ['bip122:0'] },
            { id: 'btc2', name: 'Bitcoin Wallet 2', chains: ['bip122:0'] }
        ];
    ...
    it('should only show wallets matching the active chain namespace', async () => {
        const mixedWallets = [
            { id: 'eth1', name: 'Ethereum Wallet', chains: ['eip155:1'] },
            {
                id: 'sol1',
                name: 'Solana Wallet',
                chains: ['solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp']
...
//# sourceMappingURL=w3m-connect-recent-widget.test.js.map