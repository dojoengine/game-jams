...
describe('ChainController', () => {
    ...
    it('should get correct active network token address', () => {
        ...
        expect(ChainController.getActiveNetworkTokenAddress()).toEqual('eip155:1:0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee');
        mock.mockReturnValue(mainnetCaipNetwork);
        expect(ChainController.getActiveNetworkTokenAddress()).toEqual('eip155:1:0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee');
        mock.mockReturnValue(solanaCaipNetwork);
        expect(ChainController.getActiveNetworkTokenAddress()).toEqual('solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp:So11111111111111111111111111111111111111111');
        mock.mockClear();
    });
    ...
    it('should properly handle disconnect', async () => {
        ...
        ChainController.initialize([evmAdapterCustom, solanaAdapterCustom], [...requestedCaipNetworks, solanaCaipNetwork], {
            connectionControllerClient: connectionController,
            networkControllerClient
        });
    ...
    it('should handle disconnect errors gracefully', async () => {
        ...
        ChainController.initialize([customEvmAdapter], requestedCaipNetworks, {
            connectionControllerClient: evmConnectionController,
            networkControllerClient
        });
        ChainController.state.chains.set(ConstantsUtil.CHAIN.EVM, {
