...
import { AccountController, BlockchainApiController, ChainController, CoreHelperUtil, SnackController, SwapController } from '../../exports/index.js';
// -- Setup --------------------------------------------------------------------
...
const networks = [extendedMainnet];
// -- Tests --------------------------------------------------------------------
beforeAll(() => {
...
describe('AccountController', () => {
    ...
    describe('fetchTokenBalance()', () => {
        ...
        it('should fetch balance if everything is correct', async () => {
            ...
            expect(setTokenBalanceSpy).toHaveBeenCalledWith(expect.arrayContaining([
                { quantity: { decimals: '18' }, symbol: 'ETH' },
                { quantity: { decimals: '6' }, symbol: 'USDC' }
            ]), 'eip155');
