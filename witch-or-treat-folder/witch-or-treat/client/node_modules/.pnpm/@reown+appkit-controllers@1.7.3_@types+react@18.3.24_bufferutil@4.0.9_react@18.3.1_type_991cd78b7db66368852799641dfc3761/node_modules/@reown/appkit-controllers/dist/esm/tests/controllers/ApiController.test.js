...
import { ApiController, AssetController, ChainController, ConnectorController, OptionsController } from '../../exports/index.js';
...
// -- Tests --------------------------------------------------------------------
beforeAll(() => {
    global.URL.createObjectURL = vi.fn((file) => `blob:${file}`);
...
describe('ApiController', () => {
    ...
    it('should fetch excludedWalletIds and check if RDNS of EIP6963 matches', async () => {
        ...
        const result = EIP6963Wallets.filter(wallet => !ApiController.state.excludedWallets.some(excludedWallet => excludedWallet.rdns === wallet.rdns));
